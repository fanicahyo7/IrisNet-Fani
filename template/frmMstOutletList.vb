...
Public Class frmMstOutletList
    Sub refres()
        Dim sql As String = "Select Kode, Nama, Alamat, Kota, Telepon, Faks from mstOutlet"
        dgList.FirstInit(sql, {0.5, 1, 1, 0.8, 0.5, 0.5})
        dgList.RefreshData()
    End Sub
    Private Sub frmMstOutletList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        koneksi()
        refres()
    End Sub
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        ...
        Else
            ...
            If question = vbYes Then
                query = "delete from mstOutlet where Kode='" & dgList.GetRowCellValue(dgList.FocusedRowHandle, "Kode") & "'"
