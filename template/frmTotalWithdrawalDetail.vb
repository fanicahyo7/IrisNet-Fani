...
Public Class frmTotalWithdrawalDetail
    ...
    Private Sub frmTotalWithdrawalDetail_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim query As String = _
            "select a.Faktur,a.Tanggal,a.KdCustomer,a.Keterangan, case when (sum(isnull(b.Jumlah,0))-sum(isnull(a.Total,0))) = 0 then max(a.Total) end as TotalLunas " & _
            ",case when (sum(isnull(b.Jumlah,0))-sum(isnull(a.Total,0))) <> 0 then max(a.Total) end as TotalBelumLunas " & _
            "from trSLHeader a " & _
