...
Public Class frmMstPenerbitList
    Sub refres()
        Dim sql As String = "Select Kode, Nama, Jenis, Alamat as AlamatLengkap, Kota, Telepon1 as Telepon, Faks, NamaCP as ContactPerson from MstPenerbit"
        dgList.FirstInit(sql, {0.5, 1, 0.5, 0.8, 0.5, 0.5, 0.5, 0.5})
        dgList.RefreshData()
    End Sub
    Private Sub frmMstPenerbitList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        koneksi()
        refres()
    End Sub
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        ...
        Else
            ...
            If question = vbYes Then
                query = "delete from mstPenerbit where Kode='" & dgList.GetRowCellValue(dgList.FocusedRowHandle, "Kode") & "'"
