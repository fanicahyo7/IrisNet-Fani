...
Public Class frmLapForecastHutang
    ...
    Private Sub btnAmbilData_Click(sender As Object, e As EventArgs) Handles btnAmbilData.Click
        Dim sql As String = _
            "select MingguKe,KdUnit,TotalOmzet,TotalBO, TotalOmzet+TotalBO as BoOmzet, Prosentase,TotalQuota,QuotaAwal,TotalPengajuan," & _
        ...
        dgPerhitunganUnit.FirstInit(sql, {0.8, 0.5, 1, 1, 1, 0.8, 1, 1, 1, _
                                    0.8, 1, 1, 1, 1, 1, _
                                      ...
                                      {"KdUnit", "TglPengajuanAwal", "TglPengajuanAkhir", "TglOmzetAwal", "TglOmzetAkhir", "SaldoAwal"})
