Imports meCore
Public Class frmPenjualanBOUtm

    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        Dim pquery As String =
        "SELECT Faktur, Tanggal, FakturOrder, KdCustomer, NamaCustomer, Jenis, KdGudang, KdSalesman, Total, Keterangan, UserEntry, DateTimeEntry, Transaksi, StatusPajak " & _
        "FROM vwSLHeader " & _
