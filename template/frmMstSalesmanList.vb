...
Public Class frmMstSalesmanList
    Sub refres()
        Dim sql As String = "Select Kode, Nama, Alamat, Kota, Telepon, Handphone, Email from mstSalesman order by kode"
        dgList.FirstInit(sql, {0.5, 1, 1, 0.8, 0.5, 0.5, 0.8})
        dgList.RefreshData()
    End Sub
    Private Sub frmMstSalesmanList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        koneksi()
        refres()
    End Sub
    ...
    Private Sub btnBaru_Click(sender As Object, e As EventArgs) Handles btnBaru.Click
        Using xx As New frmMstSalesman
            xx.ShowDialog(Me)
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        ...
        Else
            ...
            If question = vbYes Then
                query = "delete from mstSalesman where Kode='" & dgList.GetRowCellValue(dgList.FocusedRowHandle, "Kode") & "'"
